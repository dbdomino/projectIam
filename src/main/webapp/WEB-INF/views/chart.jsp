...
<head>
    ...
    <!-- morris chart -->
    <link rel="stylesheet" type="text/css" href="resources/css/morris.js/css/morris.css">
    <!-- Style.css -->
...
<script src="resources/js/morris.js/morris.js"></script>
<!-- Custom js -->
<script src="resources/js/morris-custom-chart.js"></script>
