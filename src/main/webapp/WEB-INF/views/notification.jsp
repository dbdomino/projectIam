...
<head>
    ...
    <!-- Notification.css -->
    <link rel="stylesheet" type="text/css" href="resources/pages/notification/notification.css">
    <!-- Animate.css -->
    <link rel="stylesheet" type="text/css" href="resources/css/animate.css/css/animate.css">
    <!-- Style.css -->
...
<script type="text/javascript" src="resources/pages/notification/notification.js"></script>
