                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box waves-effect waves-light" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius" src="resources/images/avatar-3.jpg" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="resources/images/avatar-2.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="resources/images/avatar-4.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box waves-effect waves-light" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="resources/images/avatar-3.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
        ...
        <div class="showChat_inner">
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-radius img-radius m-t-5" src="resources/images/avatar-3.jpg" alt="Generic placeholder image">
                </a>
            ...
            <div class="media chat-messages">
                ...
                <div class="media-right photo-table">
                    <a href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="resources/images/avatar-4.jpg" alt="Generic placeholder image">
                    </a>
                </div>
            </div>
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="">
                                        <a href="dashboard-ecommerce.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="dashboard-crm.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dashboard-analytics.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dashboard-project.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="menu-static.jsp" class="waves-effect waves-dark">
                                            ...
                                            <li class=" ">
                                                <a href="menu-header-fixed.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="menu-compact.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="menu-sidebar.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                    ...
                                    <li class=" pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="menu-horizontal-static.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                                    <span class="pcoded-mtext">Static Layout</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            ...
                                            <li class=" ">
                                                <a href="menu-horizontal-fixed.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="menu-horizontal-icon.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="menu-horizontal-icon-fixed.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="menu-bottom.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="box-layout.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="menu-rtl.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                            ...
                            <li class="">
                                <a href="navbar-light.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="widget-statistic.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="widget-data.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="widget-chart.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="widget-chart-advance.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu active pcoded-trigger">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="alert.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="box-shadow.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="generic-class.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="active">
                                        <a href="progress-bar.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="preloader.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="other.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="draggable.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="bs-grid.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="light-box.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="modal.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="notify.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="rating.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="range-slider.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="slider.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="syntax-highlighter.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="tour.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="treeview.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="nestable.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="toolbar.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="x-editable.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="session-timeout.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="session-idle-timeout.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="offline.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class=" ">
                                <a href="animation.jsp" class="waves-effect waves-dark">
                            ...
                            <li class=" ">
                                <a href="sticky.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="icon-font-awesome.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-simple-line.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-ion.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-material-design.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-icofonts.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-weather.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-typicons.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="icon-flags.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class=" ">
                                        <a href="form-elements-add-on.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="form-elements-advance.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext">Advance</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    ...
                                    <li class=" ">
                                        <a href="form-validation.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class=" ">
                                <a href="form-picker.jsp" class="waves-effect waves-dark">
                            ...
                            <li class=" ">
                                <a href="form-select.jsp" class="waves-effect waves-dark">
                            ...
                            <li class=" ">
                                <a href="form-masking.jsp" class="waves-effect waves-dark">
                            ...
                            <li class=" ">
                                <a href="form-wizard.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="ready-cloned-elements-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-currency-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-form-booking.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-form-booking-multi-steps.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-form-comment.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-form-contact.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-job-application-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-js-addition-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-login-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-popup-modal-form.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-registration-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-review-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-subscribe-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-suggestion-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="ready-tabs-form.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class=" ">
                                        <a href="bs-table-sizing.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="bs-table-border.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="bs-table-styling.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="dt-basic.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-advance.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-styling.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-api.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ajax.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-server-side.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-plugin.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-data-sources.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                                        <a href="dt-ext-autofill.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="dt-ext-basic-buttons.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class=" ">
                                                <a href="dt-ext-buttons-html-5-data-export.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-col-reorder.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-fixed-columns.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-fixed-header.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-key-table.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-responsive.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-row-reorder.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-scroller.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class=" ">
                                        <a href="dt-ext-select.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class=" ">
                                <a href="foo-table.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="handson-appearance.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-data-operation.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-rows-cols.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-columns-only.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-cell-features.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-cell-types.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-integrations.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-rows-only.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="handson-utilities.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="editable-table.jsp" class="waves-effect waves-dark">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="chart-google.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-echart.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-chartjs.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-float.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-knob.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-nvd3.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-peity.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-radial.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-rickshaw.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-sparkline.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="chart-c3.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="">
                                        <a href="map-vector.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="map-api.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="location.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="extra-pages/landingpage/index.jsp" target="_blank" class="waves-effect waves-dark">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="auth-normal-sign-in.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="auth-normal-sign-in-header-footer.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="auth-sign-in-social.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="auth-sign-in-social-header-footer.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="auth-sign-up.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">Simple</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            ...
                                            <li class="">
                                                <a href="auth-sign-up-header-footer.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">Header &amp; Footer</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            ...
                                            <li class="">
                                                <a href="auth-sign-up-social.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">Social</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            ...
                                            <li class="">
                                                <a href="auth-sign-up-social-header-footer.jsp" target="_blank" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">Social With Header &amp; Footer</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                    ...
                                    <li class="">
                                        <a href="auth-multi-step-sign-up.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="auth-reset-password.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="auth-lock-screen.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="auth-modal.jsp" target="_blank" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext">Modal</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="error.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="comming-soon.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="offline-ui.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="timeline.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="timeline-social.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="user-profile.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext">User Profile</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    ...
                                    <li class="">
                                        <a href="user-card.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="product.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="product-list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="product-edit.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="product-detail.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="product-cart.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="product-payment.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="email-compose.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="email-inbox.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="email-read.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="extra-pages/email-templates/email-welcome.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="extra-pages/email-templates/email-password.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="extra-pages/email-templates/email-newsletter.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="extra-pages/email-templates/email-launch.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            ...
                                            <li class="">
                                                <a href="extra-pages/email-templates/email-activation.jsp" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="fb-wall.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="message.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="task-list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="task-board.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="task-detail.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="issue-list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="todo.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext">To-Do</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    ...
                                    <li class="">
                                        <a href="notes.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="gallery-grid.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="gallery-masonry.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="gallery-advance.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="search-result.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="search-result2.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="job-card-view.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="job-details.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="job-find.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="job-panel-view.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="ck-editor.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="wysiwyg-editor.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="ace-editor.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="long-press-editor.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="invoice.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                            <span class="pcoded-mtext">Invoice</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    ...
                                    <li class="">
                                        <a href="invoice-summary.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="invoice-list.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="event-full-calender.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    ...
                                    <li class="">
                                        <a href="event-clndr.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <li class="">
                                <a href="image-crop.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="">
                                <a href="file-upload.jsp" class="waves-effect waves-dark">
                            ...
                            <li class="">
                                <a href="change-loges.jsp" class="waves-effect waves-dark">
...
<!-- Required Jquery -->
    <script type="text/javascript" src="resources/js/jquery/jquery.min.js"></script>     <script type="text/javascript" src="resources/js/jquery-ui/jquery-ui.min.js "></script>     <script type="text/javascript" src="resources/js/popper.js/popper.min.js"></script>     <script type="text/javascript" src="resources/js/bootstrap/js/bootstrap.min.js "></script>
<!-- waves js -->
<script src="resources/pages/waves/js/waves.min.js"></script>
<!-- jquery slimscroll js -->
<script type="text/javascript" src="resources/js/jquery-slimscroll/jquery.slimscroll.js "></script>
<!-- modernizr js -->
    <script type="text/javascript" src="resources/js/SmoothScroll.js"></script>     <script src="resources/js/jquery.mCustomScrollbar.concat.min.js "></script>
