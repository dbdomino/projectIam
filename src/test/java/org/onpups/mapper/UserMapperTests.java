...
// SELECT DATE_FORMAT(regDate , '%y-%m-%d %T') AS CREATE_DATE FROM table_user;
//		Mapper1.insertCol1("새타이틀1dofamero아하111", "go#@&))(@&*_)@{}@@)urod.채젝", 111);
		TableUserVO vo = new TableUserVO();
		vo.setId("userTest03");
		vo.setNick("오가");
		vo.setEmail("cmbneec@dsfwer.com");
...
//	@Test
	public void testIdcheck() {
		...
		log.info("board_before: ----------------");
		log.info("Mapper1.idcheck(\"user01\"): ----------------"+Mapper1.idcheck("user01"));
//		Mapper1.read(3);
		if(tmp == null) {
			log.info("------------------------check yes");
		} else {
...
//		TableUserVO vo = new TableUserVO();
//		vo.setId("user01");
//		log.info("loginCheck_before: ----------------");
//		log.info("Mapper1.loginCheck(\"user01\"): ----------------"+Mapper1.loginCheck(vo));
//		Mapper1.read(3);
...
//	@Test
	public void testUpdate() {
		...
		vo.setNum(7);
		vo.setNick("다이소4");
//		vo.setEmail("dower33c@dsfwer.com");
		vo.setPassword("1q2w3e4r");
...
//	@Test
	public void testUpdate2() throws ParseException {
		/*
